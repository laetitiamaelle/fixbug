    ...
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center gap-3">
        <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-100 text-slate-700">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 20a8 8 0 1 0 0-16 8 8 0 0 0 0 16Z"/><path d="M12 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="M4.93 4.93l1.41 1.41"/><path d="M17.66 17.66l1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="M6.34 17.66l-1.41 1.41"/><path d="M19.07 4.93l-1.41 1.41"/></svg>
        </span>
        <div>
          <h2 className="text-lg font-semibold tracking-tight text-[#12151F]">Paramètres du projet</h2>
          <p className="text-sm text-slate-500">Gérez les informations et la danger zone de votre projet.</p>
        </div>
      </div>

      <form onSubmit={handleEnregistrer} className="space-y-5 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
