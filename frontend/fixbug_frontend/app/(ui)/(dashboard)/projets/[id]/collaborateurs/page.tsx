...
import { Search, UserPlus, X, Trash2, Users2, Clock, Loader2 } from "lucide-react";
        ...
        <div className="space-y-6">
            <div className="rounded-xl border border-slate-200 bg-white p-5">
                ...
                <div className="relative">
                    ...
                    <Input placeholder="..." className="pl-9 pr-9" value={recherche} onChange={(e) => setRecherche(e.target.value)} />
                    {/* NOUVEAU : spinner pendant la recherche */}
                    {rechercheEnCours && <Loader2 className="absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 animate-spin text-slate-400" />}
                </div>
                {resultats.length > 0 && (
